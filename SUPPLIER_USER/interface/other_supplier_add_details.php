...
<head>
	<title>View Profile</title>
       ...
       <link rel="stylesheet" href="../css/other_supplier_add_details.css">
			...
			<div align="center">
				<fieldset style="width: 650px; height: 950px;">
					...
					<table style="width: 550px; height: 800px; border: none;">
						...
						<tr>
							<td style="border-bottom: none;"><a href="all_suppliers_selling_post.php">Other Supplier's Post</a></td>
						 ...
						 <td align="right" style="border-bottom: none;">
								...
								<input style="width:100px;height: 50px;" type="button" name="button" value="ACCEPT" onclick= "return supplierAcceptCheck()" >
