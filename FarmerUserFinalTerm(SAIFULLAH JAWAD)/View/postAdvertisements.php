    ...
    <body>
            ...
            <tr height="500px">
                ...
                <td align="Center"> 
                    ...
                    <form action="../Controller/postAdvertisementsValidation.php" method="POST"  onsubmit="return advertisementsValidation();">
            ...
            <script type="text/javascript">
                ...
                function cropPictureValidation()
                {
                    ...
                    else
                    {
                        ...
                        xhttp.open("POST", "../Controller/postAdvertisementsValidation.php", true);
