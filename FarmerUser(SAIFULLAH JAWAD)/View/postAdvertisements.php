<?php
    ...
    // if(isset($_SESSION["enteredCropPictureValidation"]))
    // {
    //     unset($_SESSION["enteredCropPictureValidation"]);
    // }
    // else
    // {
            ...
            <tr height="500px">
                ...
                <td align="Center"> 
                    ...
                    <fieldset style="display: inline-block;" >
                        ...
                        <legend><h2>Post CROP SELLING ADVERTISEMENTS</h2></legend>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="../Controller/postAdvertisementsValidation.php" method="POST">
                                        ...
                                        <table align="center">
                                            ...
                                            <tr height="40px">
                                                ...
                                                <td style="padding-left: 5px;"> <input type="text" id="cropName" name="cropName" size="30" value= "<?php echo $_SESSION["previousInput"]["cropName"] ?? ""; ?>" > </td>
                                            ...
                                            <tr height = "40px">
                                                ...
                                                <td style="padding-left: 5px;"> <input type="text" id="cropQuantity" name="cropQuantity" size="30" value= "<?php echo $_SESSION["previousInput"]["cropQuantity"] ?? "" ;?>" > </td>
                                            ...
                                            <tr height = "40px">
                                                ...
                                                <td style="padding-left: 5px;"> <input type="text" id="cropPrice" name="cropPrice" size="30" value= "<?php echo $_SESSION["previousInput"]["cropPrice"] ?? ""; ?>" > </td>
                                ...
                                <td valign="top">
                                    ...
                                    <form action="../Controller/cropPictureValidation.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="<?php if(isset($_SESSION["cropPicture"])) {echo "../View/img/".$_SESSION["cropPicture"];} else{echo "../View/img/crops.png";}?>" alt="" width="150px" height="150px">
